...
const CarListItem = ({item}) => {
    ...
    return (
     <div 
        ...
        className='flex flex-col mt-10 w-[315px] h-[600px] shadow-customGray overflow-hidden rounded-xl text-customGray cursor-pointer transition-transform duration-300 hover:scale-105 hover:shadow-2xl bg-gradient-to-r from-gray-500 to-white'
