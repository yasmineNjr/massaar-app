...
const CarListItem = ({item}) => {
    ...
    return (
     <div 
        ...
        className='flex flex-col mt-10 w-[315px] h-[600px]  overflow-hidden rounded-xl text-customGray cursor-pointer   bg-gradient-to-r from-gray-500 to-white'
        // transition-transform duration-300 hover:scale-105 shadow-customGray hover:shadow-2xl
