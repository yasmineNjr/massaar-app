...
const FeedbackCard = ({ content, name, title, img, date }) =>   (
  ////feedback-card
    <div className='flex justify-between flex-col px-10 py-12 rounded-[20px] max-w-[250px] md:mr-10 sm:mr-5 mr-0 my-5 hover:bg-gradient-to-r from-gray-300 to-white hover:shadow-customGray text-dimWhite hover:text-primary'>
